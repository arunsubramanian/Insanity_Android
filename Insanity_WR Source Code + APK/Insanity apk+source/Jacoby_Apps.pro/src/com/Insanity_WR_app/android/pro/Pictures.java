...
public class Pictures extends Activity{
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    switch (item.getItemId()) {
	        case 1:   
	        	Intent i= new Intent(Pictures.this,WorkoutList.class);
	        	startActivity(i); 
	        break;
	       
	        case 2:     
	        	Intent i2= new Intent(Pictures.this,PreviousFitTest.class);
	        	startActivity(i2);                   
	        break;
	        
	       
	        case 3: 
	        	Intent i3= new Intent(Pictures.this,Status.class);
	        	startActivity(i3);  
		        break;
	        case 4: 
	        	Intent i4= new Intent(Pictures.this,Reminder.class);
	        	startActivity(i4);  
		        break;
	        case 5: 
	        	Intent i5= new Intent(Pictures.this,Goal.class);
	        	startActivity(i5);  
		        break;
