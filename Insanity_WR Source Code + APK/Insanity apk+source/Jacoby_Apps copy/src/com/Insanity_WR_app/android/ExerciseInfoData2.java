...
public class ExerciseInfoData2 {
	...
	private static final String DATABASE_NAME = "Activities2";
	private static final String DATABASE_TABLE="ExerciseTable2";
	...
	public ExerciseInfoData2 (Context c){
		ourContext=c;
	}
	public ExerciseInfoData2 open() throws SQLException{
	...
	public long resetData(String [] value) {
